...
//Stack works on LIFO model -Abstastract Datastructure
//we get elements in reversed order .
//eg if we push 1,2,3,4 we will get 4,3,2,1 
//push,pop,top,empty,size

//Stack works on FIFO model -Abstastract Datastructure
